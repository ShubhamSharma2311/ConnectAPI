  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-900 to-gray-700 text-white flex flex-col items-center justify-center p-4 sm:p-10">
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 px-2 sm:px-4">
        {/* Card 1: List New API */}
        <div className="bg-white bg-opacity-20 backdrop-blur-md p-3 sm:p-8 rounded-2xl shadow-2xl hover:scale-105 transition transform mx-auto w-full max-w-xs sm:max-w-none my-2">
          <div className="mb-3 sm:mb-4 flex justify-center">
            <svg className="w-6 h-6 sm:w-12 sm:h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
            </svg>
          </div>
          <h2 className="text-xl sm:text-3xl font-bold text-black mb-2 text-center">List New API</h2>
          <p className="text-gray-800 text-xs sm:text-base text-center mb-3 sm:mb-4">
        ...
        <div className="bg-white bg-opacity-20 backdrop-blur-md p-3 sm:p-8 rounded-2xl shadow-2xl hover:scale-105 transition transform mx-auto w-full max-w-xs sm:max-w-none my-2">
          ...
          <h2 className="text-xl sm:text-3xl font-bold text-black mb-2 text-center">My APIs</h2>
          <p className="text-gray-800 text-xs sm:text-base text-center mb-3 sm:mb-4">
